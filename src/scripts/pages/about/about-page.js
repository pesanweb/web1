export default class AboutPage {
  async render() {
    return `
      <section id="about-page" class="container mx-auto px-6 py-20 max-w-4xl animate-in fade-in duration-500">
        <h1 class="text-4xl font-bold mb-8 text-gray-800">Tentang Orang Muda</h1>
